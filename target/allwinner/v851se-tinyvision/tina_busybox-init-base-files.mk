############################################################################################
# 			v851se-tinyvision busybox-init-base-files for tina(OpenWrt) Linux
#
#	v851se-tinyvision busybox-init-base-files will generate shell script according to some 
...
all:
	@echo ==================================================
	@echo target/allwinner/v851se-tinyvision/tina_busybox-init-basefiles.mk is called to generate shell scripts
	@echo ==================================================
...
clean:
	@echo ==================================================
	@echo target/allwinner/v851se-tinyvision/tina_busybox-init-basefiles.mk is called to clean shell scripts
	@echo ==================================================
